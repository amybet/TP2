...
public class ViewFirstAdmin {
	...
	private ViewFirstAdmin() {
		...
		theFirstAdminScene.getStylesheets().add(getClass().getResource("/applicationMain/application.css").toExternalForm());
		...
		setupLabelUI(label_InvalidPassword, "Arial", 18, width, Pos.CENTER, 0, 300);
		...
		theRootPane.getChildren().addAll(label_ApplicationTitle, label_TitleLine1,
				...
				text_AdminPassword2, button_AdminSetup, label_PasswordsDoNotMatch,label_InvalidPassword,label_InvalidUsername,
				button_Quit);
	}
