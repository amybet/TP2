...
public class ReplyOperationsTests {
    ...
    public static void testCreateReply_linkedToParentPost() {
        ...
        post p = new post(100, "bob", "Original Question", "Help?", "2025-03-01 10:00", false);
    ...
    /**
     * Verifies that all reply accessor (getter) methods accurately return the values provided at construction.
     * <p>
    ...
    public static void testDeleteReply_removedFromPost() {
        ...
        post p = new post(500, "henry", "Post", "Body.", "2025-03-05 06:00", false);
    ...
    public static void testDeleteReply_remainingRepliesIntact() {
        ...
        post p = new post(501, "julia", "Post", "Body.", "2025-03-06 05:00", false);
    ...
    public static void testViewReplies_count() {
        ...
        post p = new post(600, "nancy", "Post", "Body.", "2025-03-07 04:00", false);
    ...
    public static void testViewReplies_addAndRemoveMultiple() {
        ...
        post p = new post(601, "rachel", "Post", "Body.", "2025-03-08 03:00", false);
    ...
    /**
     * Verifies that a reply can safely and successfully transition through its entire lifecycle 
     * (Creation -> Modification -> Deletion) without throwing errors or corrupting its parent post.
     * <p>
     * <b>Intent:</b> Proves the overall stability and interoperability of the Create, Update, and Delete 
    ...
    public static void testStateTransition_createdToUpdatedToDeleted() {
        ...
        post p = new post(700, "victor", "Host Post", "Body.", "2025-03-09 02:00", false);
