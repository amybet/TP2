...
public class PostDeletionTests {
    ...
    public static void main(String[] args) {
        ...
        // Reply removal (post entity behavior)
        testReplyRemoval_removedFromList();
        testReplyRemoval_postUnaffected();
        testReplyRemoval_otherRepliesUnaffected();
    ...
    /**
     * Verifies that a post is correctly soft-deleted by setting its flag to true.
     * <p>
     * <b>Intent:</b> Ensures the post remains available to preserve relational data (like replies),
     ...
     * <p>
     * <b>Intent:</b> Ensures that viewers do not see the original title of a deleted post, satisfying
     * the requirement to display a deletion marker.
     * </p>
     */
     ...
     * <p>
     * <b>Intent:</b> Ensures the original content is hidden from viewers, directly supporting the user
     * story requirement to mask deleted information.
     * </p>
     */
    ...
    /**
     * Verifies that the post's author is preserved after a soft delete.
     * <p>
     * <b>Intent:</b> Proves that the deletion process only alters the title and content, maintaining
     ...
     * <p>
     * <b>Intent:</b> Confirms that the post's unique identifier remains intact, which is crucial for
     * keeping replies successfully linked to the post.
     * </p>
     */
     ...
     * <p>
     * <b>Intent:</b> Proves that the post's soft-deletion logic does not cascade and overwrite
     * community replies.
     * </p>
     */
    public static void testSoftDelete_replyContentUnchanged() {
        section("8) Soft Delete – reply content is not altered by post deletion\n");
    ...
    public static void testDeletedPost_markerVisibleToViewer() {
        ...
        check("viewer sees the deleted title marker", DELETED_MARKER.equals(p.getTitle()));
        check("viewer sees the deleted content marker", DELETED_MARKER.equals(p.getContent()));
        check("isDeleted flag true for viewer", p.getDeleted());
    }

    /**
     * Verifies that a post with multiple replies preserves all of them upon deletion.
     * <p>
     * <b>Intent:</b> Stress-tests the requirement that replies remain accessible, ensuring no data loss
     * occurs when many replies exist.
     * </p>
     */
    ...
    /**
     * Verifies that removing a reply successfully deletes it from the parent post's list.
     * <p>
     * <b>Intent:</b> Confirms that reply removal unlinks the reply from the post entity.
     * </p>
     */
    public static void testReplyRemoval_removedFromList() {
        section("11) Reply Removal – reply removed from post's list\n");
    ...
    /**
     * Verifies that removing a reply does not accidentally delete or modify the parent post.
     * <p>
     * <b>Intent:</b> Proves the isolation of the reply removal, ensuring post content and deleted
     * state remain unaffected.
     * </p>
     */
    public static void testReplyRemoval_postUnaffected() {
        section("12) Reply Removal – parent post not modified by reply removal\n");
    ...
    /**
     * Verifies that removing one specific reply does not alter or remove any sibling replies.
     * <p>
     * <b>Intent:</b> Confirms that other replies are unaffected when removing a reply.
     * </p>
     */
    public static void testReplyRemoval_otherRepliesUnaffected() {
        section("13) Reply Removal – other replies unaffected\n");
    ...
    /**
     * Verifies that triggering the soft delete process twice on the same post does not cause errors.
     * <p>
    ...
    /**
     * Builds a non-deleted post with fixed title, content, thread, and timestamp for testing purposes.
     *
    ...
    public static post buildPost(int id, String author) {
        // Thread added to post: default test thread is "General"
        return new post(id, author, "Test Title", "Test content.", "General", "2025-01-01 00:00", false);
    }

    /**
     * Performs a soft delete operation by setting the deleted flag to true and replacing the title and content.
     *
